				...
				<div class="container">
					<div class="row">
						<div class="col-sm-8 col-md-7 py-4">
							...
							<div style="margin-top: 0px; color: Gray;">
								<p >Mid-City Automotive has been serving the greater metropolitan area 
									for over 70 years. Visit our showroom today to see the finest new and used vehicles 
									available anywhere!</p>
									<span>4400 Central City Parkway</span>&nbsp;&diams;&nbsp;<span>Fairborn, OH 45324</span>
									&nbsp;&diams;&nbsp;<span>937.555.2121</span>
							</div>
						...
						<div class="col-sm-4 offset-md-1 py-4">
							...
							<ul class="list-unstyled">
								<li><a href="vehicle.jsp" class="text-white">Add A Car To Inventory</a></li>
								<li><a href="reports.jsp" class="text-white">Sales Reports</a></li>
